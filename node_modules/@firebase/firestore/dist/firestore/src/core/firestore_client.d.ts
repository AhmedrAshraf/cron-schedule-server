...
export declare function firestoreClientLoadBundle(client: FirestoreClient, data: ReadableStream<Uint8Array> | ArrayBuffer | string, resultTask: LoadBundleTask): Promise<void>;
