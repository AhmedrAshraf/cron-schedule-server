 ...
 */
export declare function hasNewerBundle(localStore: LocalStore, bundleMetadata: ProtoBundleMetadata): Promise<boolean>;
/**
 * Saves the given `BundleMetadata` to local persistence.
 */
export declare function saveBundle(localStore: LocalStore, bundleMetadata: ProtoBundleMetadata): Promise<void>;
/**
 ...
 */
export declare function saveNamedQuery(localStore: LocalStore, query: ProtoNamedQuery, documents?: DocumentKeySet): Promise<void>;
